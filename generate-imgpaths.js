...
const headingMaps = {
    ...
    'icon-house2': [["houses", "above_map"]],
    'icon-DSICON': [["ds"]],  
    'icon-LIBICON': [["library", "above_blue"]],
    'icon-alt-STRICON': [[]]
};
...
const coordinates = {
    ...
    'BG-steets-glow': {x:960, y:540, moveMode:-1, zIndex:3, scale:1, flipX:false, angle:0},
    'stripRes-dice-blue': {x:660, y:231.6, moveMode:1, zIndex:6, scale:1, flipX:false, angle:0},
    ...
    'stripRes-dice-red2': {x:482.4, y:772.4, moveMode:1, zIndex:9, scale:1, flipX:false, angle:0},
    'stripRes-dice': {x:1628, y:858.8, moveMode:1, zIndex:9, scale:1, flipX:false, angle:0},
    ...
    'above_blue-glass-effect': {x:1325.6, y:196.4, moveMode:-1, zIndex:7, scale:1, flipX:false, angle:0}, 
    'above_map-poker-chips1': {x:1786, y:834, moveMode:-1, zIndex:4, scale:1.25, flipX:false, angle:0},
    'above_map-poker-chips2': {x:142, y:0, moveMode:-1, zIndex:4, scale:1, flipX:false, angle:270},
    ...
    'below_blue-glass': {x:419, y:507, moveMode:-1, zIndex:-10, scale:1.55, flipX:false, angle:0},
    'below_blue-cool-dice': {x:490, y:230, moveMode:0, zIndex:-10, scale:1, flipX:false, angle:0},
    'below_blue-cool-dice2': {x:889, y:689, moveMode:1, zIndex:-10, scale:1, flipX:false, angle:20},
    'below_blue-cool-dice3': {x:212, y:350, moveMode:1, zIndex:-10, scale:0.75, flipX:false, angle:180},
    'below_blue-sign': {x:1900, y:488, moveMode:2, zIndex:-8, scale:0.55, flipX:false, angle:0},
    'strip4-hand': {x:0, y:0, moveMode:-1, zIndex:0, scale:1, flipX:false, angle:0},
    'above_blue-elvis1': {x:177, y:780, moveMode:-1, zIndex:7, scale:1.55, flipX:false, angle:0},
    'above_blue-elvis2': {x:1816.8, y:434, moveMode:-1, zIndex:7, scale:1.25, flipX:false, angle:0},
    'above_blue-elvis3-effect': {x:1389, y:47, moveMode:-1, zIndex:7, scale:1.25, flipX:false, angle:0},
    ...
    'effect-FAKEBG': {x:960, y:540, moveMode:-1, zIndex:-9, scale:1.25, flipX:false, angle:0},
    'icon-0-LVICON': {x:1427, y:583, moveMode:-1, zIndex:8, scale:1, flipX:false, angle:0},
    'icon-alt-STRICON': {x:1427, y:583, moveMode:-1, zIndex:8, scale:1, flipX:false, angle:0},
    'icon-CHICON': {x:1170, y:510, moveMode:-1, zIndex:7, scale:0.9, flipX:false, angle:0},
    'icon-SMICON': {x:1128, y:352, moveMode:-1, zIndex:4, scale:0.9, flipX:false, angle:0},
    'alt-LIBICON': {x:0, y:0, moveMode:-1, zIndex:0, scale:1, flipX:false, angle:0}, 
    'icon-DSICON': {x:960, y:105, moveMode:-1, zIndex:4, scale:1, flipX:false, angle:0},  
    'icon-LIBICON': {x:1560, y:236, moveMode:-1, zIndex:5, scale:0.9, flipX:false, angle:0}, 
    'houseFade-house1': {x:1152, y:689, moveMode:-1, zIndex:1, scale:0.3, flipX:false, angle:0},
    'icon-house2': {x:1386, y:355, moveMode:-1, zIndex:6, scale:0.3, flipX:false, angle:0},
    ...
    'houseFade-streets-real': {x:960, y:540, moveMode:-1, zIndex:3, scale:1, flipX:false, angle:0},
    ...
    'arch-roof-99': {x:-60, y:176.8, moveMode:2, zIndex:5, scale:1, flipX:false, angle:0}, 
    'arch-roof1': {x:1385, y:973.2, moveMode:1, zIndex:5, scale:1, flipX:false, angle:0},
    'arch-roof2': {x:351.8, y:934.8, moveMode:-2, zIndex:6, scale:1, flipX:false, angle:0},
    'arch-roof2-2': {x:1967.8, y:639.8, moveMode:1, zIndex:5, scale:1, flipX:false, angle:0},
    'arch-roof3': {x:1898.4, y:140.4, moveMode:2, zIndex:5, scale:1, flipX:false, angle:0},
    'arch-roof3-2': {x:1661.4, y:874.4, moveMode:2, zIndex:5, scale:1, flipX:false, angle:90},
    'arch-roof4': {x:578.4, y:1010.8, moveMode:1, zIndex:4, scale:1, flipX:false, angle:0},
    'arch-roof4-2': {x:25.8, y:80.4, moveMode:2, zIndex:4, scale:1, flipX:false, angle:90},
    'arch-roof5': {x:1661.6, y:25.8, moveMode:2, zIndex:4, scale:1, flipX:false, angle:180},
    'arch-statue-blue': {x:184.6, y:783.6, moveMode:1, zIndex:6, scale:1, flipX:false, angle:0},
    'arch-statue-red': {x:1844.6, y:842, moveMode:2, zIndex:5, scale:1, flipX:false, angle:0},
    'cuisine-choisum-blue-1': {x:117.6, y:796.4, moveMode:1, zIndex:5, scale:1, flipX:false, angle:-25},
    'cuisine-choisum-blue': {x:1787, y:120.4, moveMode:2, zIndex:5, scale:1, flipX:false, angle:0},
    'cuisine-choisum-orange-2': {x:1540, y:833.2, moveMode:2, zIndex:5, scale:1, flipX:true, angle:0},
    'cuisine-choisum-orange': {x:1760.6, y:945.2, moveMode:1, zIndex:7, scale:1, flipX:false, angle:0},
    'cuisine-napa-blue-1': {x:677.6, y:136.4, moveMode:0, zIndex:6, scale:0.45, flipX:false, angle:190},
    'cuisine-napa-blue': {x:792.2, y:920.4, moveMode:2, zIndex:7, scale:1, flipX:false, angle:0},
    'cuisine-napa-green-2': {x:1842.6, y:500.4, moveMode:1, zIndex:4, scale:1, flipX:true, angle:0},
    'cuisine-napa-green-3': {x:1696.8, y:212.4, moveMode:1, zIndex:5, scale:0.65, flipX:true, angle:70},
    'cuisine-napa-green': {x:54.6, y:660, moveMode:0, zIndex:5, scale:1, flipX:false, angle:0},
    'cuisine-shaoxing-2': {x:368.8, y:767.2, moveMode:1, zIndex:3, scale:0.7, flipX:false, angle:10},
    'cuisine-shaoxing-3': {x:396.8, y:51.6, moveMode:2, zIndex:6, scale:0.55, flipX:false, angle:-15},
    'cuisine-shaoxing': {x:1633, y:681.6, moveMode:0, zIndex:5, scale:1, flipX:false, angle:0},
    'cuisine-soysauce-dark-1': {x:93.6, y:737.2, moveMode:2, zIndex:5, scale:0.45, flipX:false, angle:82},
    'cuisine-soysauce-dark': {x:1671, y:54, moveMode:1, zIndex:6, scale:1, flipX:false, angle:0},
    'cuisine-soysauce-light-2': {x:1777.6, y:720.8, moveMode:2, zIndex:5, scale:0.65, flipX:false, angle:10},
    'cuisine-soysauce-light': {x:258.6, y:788.4, moveMode:3, zIndex:8, scale:1, flipX:false, angle:0},
    'cuisine-tangerine-up': {x:665.4, y:21.6, moveMode:2, zIndex:1, scale:1, flipX:false, angle:0},
    'cuisine-tangerine-down': {x:521.4, y:883.2, moveMode:2, zIndex:5, scale:1, flipX:false, angle:0},
    'ds-0-lens':{x:960, y:540, moveMode:-1, zIndex:20, scale:1.25, flipX:false, angle:0},
    'ds-1-overlens':{x:960, y:540, moveMode:-1, zIndex:20, scale:1.25, flipX:false, angle:0},
    'ds-2-morange':{x:960, y:540, moveMode:-1, zIndex:20, scale:1.25, flipX:false, angle:0},
